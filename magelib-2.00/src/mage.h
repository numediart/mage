...
// --- HTS Engine & Voices (Engine) ---
			 ...
			 *	\brief It contains every Engine instance with the corresponding interpolationFunctions used from Mage.
			 */		
...
// --- Model ---
			...
			/** 
			 *	\var Model model.
			 *	\brief It contains the Model instance curently used.
			 */
			Model * model;
...
// --- SPTK vocoder ---
			...
			/** 
			*	\var int sampleCount.
			*	\brief It contains the number of sapmles genereted.
			*/
			int sampleCount;
		
			/** 
			 *	\var Vocoder vocoder.
			 *	\brief It contains the Vocoder instance curently used.
			 */
			Vocoder * vocoder;
...
// --- Frame ---
			...
			/** 
			 *	\var Frame frame.
			 *	\brief It contains the Frame instance curently used.
			 */
			Frame frame;
...
// --- Label ---
			...
			/** 
			 *	\var Label label.
			 *	\brief It contains the Label instance curently used.
			 */
			Label label;
		
			/** 
			 *	\var double labelSpeed.
			 *	\brief It contains the speed of the curently used Label instance.
			 */
