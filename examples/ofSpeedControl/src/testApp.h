...
class testApp : public ofBaseApp 
{
	public:
		...
		// gui
		MyTestObject slider_speed_overwrite;
		MyTestObject slider_speed_shift;
	...
	protected:
		...
		int	  speedAction;		// pitchAction ( noaction, overwrite, shift, scale, synthetic ) value set by the user
